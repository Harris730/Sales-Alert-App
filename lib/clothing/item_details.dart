import 'package:category/clothing/add_image.dart';
      ...
      body: SafeArea(
        ...
        child:Column(
            children: [
              ...
              SizedBox(height: 8.h),
              MyTextField(controller: item_namecontroller, hintText: '', obscureText: false),
              ...
              SizedBox(height: 8.h),
              MyTextField(controller: item_pricecontroller, hintText: '', obscureText: false),
              SizedBox(height: 15.h),
              Container(
                alignment:Alignment.topLeft,
                margin: EdgeInsets.only(left: 30.w),
              ...
              SizedBox(height: 8.h),
              MyTextField(controller: item_quantitycontroller, hintText: '', obscureText: false),
              SizedBox(height: 15.h),
              Container(
                alignment:Alignment.topLeft,
                margin: EdgeInsets.only(left: 30.w),
              ...
              SizedBox(height: 8.h),
              MyTextField(controller: item_descriptioncontroller, hintText: '', obscureText: false),
              SizedBox(height: 15.h),
              Container(
                alignment:Alignment.topLeft,
                margin: EdgeInsets.only(left: 30.w),
              ...
              SizedBox(height: 8.h),
              MyTextField(controller: item_colorcontroller, hintText: '', obscureText: false),
              SizedBox(height: 20.h),
              MyButton(
                  label: "Next",
                  onPress: () {
                    if(!item_namecontroller.text.isEmpty && !item_pricecontroller.text.isEmpty
                        &&!item_quantitycontroller.text.isEmpty &&!item_descriptioncontroller.text.isEmpty &&
